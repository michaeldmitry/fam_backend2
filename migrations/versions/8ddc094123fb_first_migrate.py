...
Revision ID: 8ddc094123fb
Revises: 
Create Date: 2021-01-29 08:33:49.179915
...
def upgrade():
    ...
    sa.Column('paid', sa.Float(), nullable=True),
    sa.Column('total_price', sa.Float(), nullable=True),
    sa.Column('sale_type', sa.Boolean(), nullable=True),
    ...
    sa.Column('root_replacement_id', sa.Integer(), nullable=True),
    sa.Column('subcategory_id', sa.Integer(), nullable=True),
    sa.Column('brand_id', sa.Integer(), nullable=True),
    sa.Column('attributes', sa.JSON(), nullable=True),
    sa.ForeignKeyConstraint(['brand_id'], ['brand.id'], ),
    sa.ForeignKeyConstraint(['replaces_id'], ['product.id'], ),
